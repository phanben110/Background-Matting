...
def trimap(image, size, name =None, number= None, erosion=False):
    """
    ...
    image = unit01.morph_close(image,kernel1)
...
#    image = cv2.imread('/home/pcwork/ai/ftech/finger/trimap_generator/images/practices/ben2_alpha.png',cv2.IMREAD_GRAYSCALE)
#    #path  = "./images/test_images/test_image_11.png"
#    #path = '/home/pcwork/011.jpg' 
...
#    ben = trimap(image,size=26, erosion=False)
#    print (ben.shape)
