...
"""
#python inference_webcam.py     --model-type mattingrefine     --model-backbone resnet50     --model-checkpoint "torchscript_resnet50_fp32.pth"
...
class Camera:
    def __init__(self, device_id=4, width=1280, height=720):
...
model.load_state_dict(torch.load('/home/pcwork/ai/ftech/finger/BackgroundMattingV2/pytorch_resnet50.pth' ), strict=False)
