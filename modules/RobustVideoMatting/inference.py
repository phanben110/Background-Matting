...
python inference.py \
    ...
    --seq-chunk 1
"""
# python inference.py     --variant mobilenetv3     --checkpoint rvm_mobilenetv3.pth     --device cuda     --input-source '/home/pcwork/Videos/Webcam/2021-09-04-113212.webm'      --output-type video     --output-composition "composition.mp4"     --output-alpha "alpha.mp4"     --output-foreground "foreground.mp4"     --output-video-mbps 4     --seq-chunk 1
